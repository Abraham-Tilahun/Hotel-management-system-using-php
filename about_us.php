		  ...
		  <div id="sidebar">
		    ...
		    <div class="block">
			  <div class="block">
					...
					yegofview hotel provides its customers with the highest standard of service and is committed to do that for all its respected guests. In addition to the existing accommodation, we are constructing additional 70 luxury rooms, ballroom and restaurant to meet the ever-growing customer demand. In short, we are here to give you a service for your highest level of satisfaction.<br>
			    Services				
					</div>
					<ul><br>
		...
		echo '<img src="images/white.jpg" width="210" height="0"><span class="style14 style13"> Welcome <a href="'; echo $role.".php"; echo'" class="style14 style13">'; echo strtoupper($username); echo'</a></span>';}
		  ?>
			  <div class="block">
			    ...
			    <br>
					<h4>Last News</h4>
				  <p><strong>yegofview hotel is now aiming to build a new second branch in kombolcha city.</strong> As the manager specifies the new hotel will have so many new features.<br />
				  </p>
				  <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  <img src="images/bed12.jpg" alt="around es hotel" width="205" height="124"><br />
				  <br />
			  ...
			  <div class="block">
			    ...
			    <p><strong>Welcome to yegofview hotel kombolcha, Ethiopia. </strong>Our hotel is fabulous and has a good hospitality like no other hotels in the city.                  
			...
			<div id="photogallery">
				...
				<a href="#" target="_blank"><img src="images/yegofe-view-hotel1.jpg" alt="" width="158" height="100" /></a>
					<span>yegofview</span>
					<a href="#" target="_blank"><img src="images/room.jpg" alt="" width="158" height="100" /></a>
					<span>kombolcha at night </span>
					<a href="#" target="_blank"><img src="images/bed13.jpg" alt="" width="158" height="100" /></a>
					<span>room </span>
