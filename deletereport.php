...
$id = $_REQUEST['id'];
    $query="DELETE FROM reservation WHERE email='$id' ";
$result=mysql_query($query);
if($result)
{
	echo"report is deleted successfully";
	echo '<meta content = "3;view_report1.php" http-equiv = "refresh"/>';
}
else
{
...
<a href="view_report1.php"align="center"style="margin-right:-200px">Back</a>
<div id="footer">
		<ul>
			<li><a href="index.php">Home</a>|</li>
			<li><a href="about_us.php" >About our Hotel</a>|</li>
