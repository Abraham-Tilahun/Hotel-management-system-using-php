...
<table cellpadding = 5 width="50%" border="0" style="background-image:url(images/bgtable.jpg) " align="center">
  ...
  <input name="search" type="text" value=""placeholder="Enter Room Number">
...
$result = mysql_query("SELECT * FROM rooms where room_no='$search'",$db);
...
echo '<td bgcolor="#b0c4de" width="60">';
echo"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=deleterooms.php?id=".$myrow['room_no']."><img width='30px' height='30px' src = 'images/delete.png' title='Delete'></img></a></td>";
echo'</td>';
echo"</tr>";
}
echo "</TABLE>";
