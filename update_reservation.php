...
<body>
	...
	<div id="content">
		  ...
		  <div id="sidebar">
		    ...
		    <span class="style15">You are here:</span><span class="style11"> <a href="index.php" class="style14">Home</a> <img src="images/arrow.gif"> <span class="style16">Update registration</span></span>
			<p>&nbsp;</p>
  ...
  <tr>
    ...
    <td align="left"><input name="preferences" type="text" id="preferences" ></td>
	  ...
	  <td colspan="2" align="center"><span class="style20">
	    <input name="update" type="submit" value="Update Registration">
...
mysql_select_db("newyegof",$con);
$sql="select  city, state, country, first_name,last_name from reservation where res_id = '$name2'";
$result = mysql_query($sql,$con);
If(!$result)
