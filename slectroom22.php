...
$child="";
$confirmation="";
$result = mysql_query("SELECT * FROM reservation1 where confirmation='$confirmation'");
...
<div class="mainwrapper">
  <div class="leftother">
	...
	<div class="r">
	<div class="right3">
  <form action="#" method="post" onsubmit="return validateForm()" name="room">
  Arrival_date<input name="start" type="hidden" value="<?php echo $arrival; ?>" />
  Departure_date<input name="end" type="hidden" value="<?php echo $departure; ?>" />
  child<input name="adult" type="hidden" value="<?php echo $adults; ?>" />
  Adults<input name="child" type="hidden" value="<?php echo $child; ?>" />
...
<div class="footer" style="text-align:center; font-family:Arial, Helvetica, sans-serif; font-size:12px;">copyright © rashotel 2006 All Rights reserved</div>
</body>
</html>
