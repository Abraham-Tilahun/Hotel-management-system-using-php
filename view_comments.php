...
<table width="326" style="float:left" >
  ...
  <tr>
    <td>Photo</td>
    <td><img border="5" src="" width="120" height="150" alt="Photo" id="picture"readonly="true">
      &nbsp;</td>
  </tr>
  <tr>
    <td>Feedback</td>
    <td><textarea name="feedback" cols="25" rows="4" resize="none" style="resize:none" id="feedback" readonly="true"></textarea>      &nbsp;</td>
		...
		$sql="delete from testimonials where name='$name' && age='$age' && job='$job' && feedback='$feedback'";
		...
		//$photo=$_POST['photo'];
		$feedback=$_POST['feedback'];
		$sql="update testimonials set status='Choosen' where name='$name' && age='$age' && job='$job'&& feedback='$feedback'";
		$result=mysql_query($sql);
		if(!$result)
		die(mysql_error());
		echo '<script language="javascript">
...
<?php echo'
	...
	<div id="footer">
		...
		<div id="copyright"> 
		  <p><span>Copyright &copy; yegofview Hotel, kombolcha, Ethiopia </span><span>&copy; Design by <a href="" target="_blank">Information Tchnology GC Students</a>&nbsp;&nbsp;&nbsp;&nbsp;</span></p>
		  <p>&nbsp;</p>
		  <p>2019</p>
		</div>
	</div>
