...
?>
	<div id="header">
		...
		<img src="images/testimonial44.jpg" alt="" width="985" height="303" /><div style="height:9px"></div>
...
mysql_close($con);
	echo '<img src="images/white.jpg" width="630" height="1"><span align="right" class="style8 style9"> Welcome <a href="'; echo $role.".php"; echo'" class="style8 style9">'; echo strtoupper($username); echo'</a></span>';}
		  ?>
  <div align="center">
<p><img src="images/testimonial22.jpg" alt="testimonials" width="697" height="354"><br>
      <img src="images/testimonial33.jpg" alt="testimonials" width="697" height="268"></p>
	  <span class="style7">Leave your comment here<br><br></span>
      <p style="float:left">&nbsp;&nbsp;<img src="images/white.jpg" width="220"></p>
	  <img src="images/commentphoto.jpg" alt="image" style="float:left"><img style="float:left" src="images/white.jpg" width="50">
